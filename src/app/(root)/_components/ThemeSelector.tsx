      ...
      <AnimatePresence>
        {isDialogOpen && (
          <motion.div
            ...
            min-w-[240px] bg-[#1e1e2e]/95 backdrop-blur-xl
          ...
          >
            ...
            {THEMES.map((t, index) => (
              <motion.button
                ...
                className={`relative group w-full flex items-center gap-3 px-3
                  py-2.5 hover:bg-[#262637] transition-all duration-200 
                  ${t.id === theme ? "bg-blue-500/10 text-blue-400" : "text-gray-300"}`}
