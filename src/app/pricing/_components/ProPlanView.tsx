...
export default function ProPlanView() {
  return (
    <div className="bg-[#0a0a0f]">
      <NavigationHeader />
      <div className="relative px-4 h-[88vh] flex items-center justify-center">
        <div className="relative max-w-xl mx-auto text-center">
          ...
          <div className="relative bg-[#12121a]/90 border border-gray-800/50 backdrop-blur-2xl rounded-2xl p-12">
            ...
            <div className="relative">
              ...
              <Link
                href={"/"}
                className="inline-flex items-center justify-center gap-2 w-full px-8 py-4 bg-gradient-to-r from-blue-500/10 to-purple-500/10
             hover:from-blue-500/20 hover:to-purple-500/20 text-white rounded-xl transition-all duration-200
              border border-gray-800 hover:border-blue-500/50 group"
              >
                <Command className="sze-5 text-blue-400" />
                <span>Open Editor</span>
                <ArrowRight className="size-5 text-purple-400 group-hover:translate-x-0.5 transition-transform" />
              </Link>
            </div>
          </div>
        </div>
